...
#ifdef CLIENT_DLL
#define CTfc_WeaponShotgun C_Tfc_WeaponShotgun
#endif

extern ConVar sk_auto_reload_time;
extern ConVar sk_plr_num_shotgun_pellets;

class CTfc_WeaponShotgun : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS(CTfc_WeaponShotgun, CBaseHL2MPCombatWeapon);
...
//	void SecondaryAttack( void );
	...
	CTfc_WeaponShotgun(void);

private:
	CTfc_WeaponShotgun(const CTfc_WeaponShotgun &);
};

IMPLEMENT_NETWORKCLASS_ALIASED( Tfc_WeaponShotgun, DT_Tfc_WeaponShotgun )

BEGIN_NETWORK_TABLE(CTfc_WeaponShotgun, DT_Tfc_WeaponShotgun)
#ifdef CLIENT_DLL
...
#ifdef CLIENT_DLL
BEGIN_PREDICTION_DATA( CTfc_WeaponShotgun )
...
LINK_ENTITY_TO_CLASS(tfc_weapon_shotgun, CTfc_WeaponShotgun);
PRECACHE_WEAPON_REGISTER(tfc_weapon_shotgun);

#ifndef CLIENT_DLL
acttable_t	CTfc_WeaponShotgun::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CTfc_WeaponShotgun);
...
// Output :
//-----------------------------------------------------------------------------
bool CTfc_WeaponShotgun::StartReload(void)
{
	if ( m_bNeedPump )
		return false;
...
// Output :
//-----------------------------------------------------------------------------
bool CTfc_WeaponShotgun::Reload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun::FinishReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun::FillClip(void)
{
	CBaseCombatCharacter *pOwner  = GetOwner();
...
// Output :
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun::Pump(void)
{
	CBaseCombatCharacter *pOwner  = GetOwner();
...
//
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun::DryFire(void)
{
	WeaponSound(EMPTY);
...
//
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun::PrimaryAttack(void)
{
...
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun::ItemPostFrame(void)
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTfc_WeaponShotgun::CTfc_WeaponShotgun(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun::ItemHolsterFrame(void)
{
	// Must be player held
...
//==================================================
/*
void CTfc_WeaponShotgun::WeaponIdle( void )
{
	//Only the player fires this way so we can cast
