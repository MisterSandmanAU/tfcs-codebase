...
#ifdef CLIENT_DLL
#define CTfc_WeaponShotgun12gauge C_Tfc_WeaponShotgun12gauge
#endif

extern ConVar sk_auto_reload_time;
extern ConVar sk_plr_num_shotgun_pellets;

class CTfc_WeaponShotgun12gauge : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS(CTfc_WeaponShotgun12gauge, CBaseHL2MPCombatWeapon);
...
//	void WeaponIdle( void );
	...
	CTfc_WeaponShotgun12gauge(void);

private:
	CTfc_WeaponShotgun12gauge(const CTfc_WeaponShotgun12gauge &);
};

IMPLEMENT_NETWORKCLASS_ALIASED(Tfc_WeaponShotgun12gauge, DT_Tfc_WeaponShotgun12gauge)

BEGIN_NETWORK_TABLE(CTfc_WeaponShotgun12gauge, DT_Tfc_WeaponShotgun12gauge)
#ifdef CLIENT_DLL
...
#ifdef CLIENT_DLL
BEGIN_PREDICTION_DATA( CTfc_WeaponShotgun12gauge )
...
LINK_ENTITY_TO_CLASS(tfc_weapon_shotgun12gauge, CTfc_WeaponShotgun12gauge);
PRECACHE_WEAPON_REGISTER(tfc_weapon_shotgun12gauge);

#ifndef CLIENT_DLL
acttable_t	CTfc_WeaponShotgun12gauge::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CTfc_WeaponShotgun12gauge);
...
// Output :
//-----------------------------------------------------------------------------
bool CTfc_WeaponShotgun12gauge::StartReload(void)
{
	if ( m_bNeedPump )
		return false;
...
// Output :
//-----------------------------------------------------------------------------
bool CTfc_WeaponShotgun12gauge::Reload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun12gauge::FinishReload(void)
{
...
// Output :
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun12gauge::FillClip(void)
{
	CBaseCombatCharacter *pOwner  = GetOwner();
...
// Output :
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun12gauge::Pump(void)
{
	CBaseCombatCharacter *pOwner  = GetOwner();
...
//
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun12gauge::DryFire(void)
{
	WeaponSound(EMPTY);
...
//
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun12gauge::PrimaryAttack(void)
{
...
//
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun12gauge::SecondaryAttack(void)
{
	// Only the player fires this way so we can cast
	CBasePlayer *pPlayer = ToBasePlayer( GetOwner() );
...
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun12gauge::ItemPostFrame(void)
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTfc_WeaponShotgun12gauge::CTfc_WeaponShotgun12gauge(void)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTfc_WeaponShotgun12gauge::ItemHolsterFrame(void)
{
	// Must be player held
...
//==================================================
/*
void CTfc_WeaponShotgun12gauge::WeaponIdle( void )
{
	//Only the player fires this way so we can cast
